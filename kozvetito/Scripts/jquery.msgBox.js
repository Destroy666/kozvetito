...
var msgBoxImagePath = "../Content/msgbox/";
...
function msg (options) {
    ...
    if (options.type != null) {
        switch (options.type) {
            case "progress":
                options.title = options.title == null ? "Progress" : options.title;
                options.content = options.content == null ? "<progress></progress>" : options.content;
                options.showButtons = options.showButtons == null ? false : options.showButtons;
                break;
            case "alert":
    ...
    divMsgBoxBackGround.click(function (e) {
        if (!options.showButtons || options.type != "progress" || options.autoClose) {
            hide();
        }
        else {
            getFocus();
